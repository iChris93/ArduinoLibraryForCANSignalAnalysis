...
int batteryVoltage=analyzeMessage.getSignal(test, 0, 16, 0.01, 0); //analyze "test" CAN message starting at bit 0 with a bit lenght of 16, a scale of 0.01, and an offest of 0
Serial.println();
Serial.print("Battery Votlage: ");
Serial.print(batteryVoltage);
Serial.print(" V");
int batteryCurrent=analyzeMessage.getSignal(test, 16, 16, -0.01, 0);
Serial.println();
Serial.print("Battery Current: ");
Serial.print(batteryCurrent);
Serial.print(" A");
int rawBatteryCurrent=analyzeMessage.getSignal(test, 32, 16, -0.05, 500);
Serial.println();
Serial.print("Raw Battery Current: ");
Serial.print(rawBatteryCurrent);
Serial.print(" A");
int chargeHoursRemaining=analyzeMessage.getSignal(test, 48, 12, 1, 0);
Serial.println();
